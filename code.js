var paintBucketApp = (function () {
	...
	var context,
		...
		drawingAreaX = 111,
		drawingAreaY = 11,
		drawingAreaWidth = 404,
		drawingAreaHeight = 685,
		colorLayerData,
		outlineLayerData,
		...
		init = function () {
			...
			backgroundImage.src = "images/nutzy-bg.png";

			swatchImage.onload = resourceLoaded;
			swatchImage.src = "images/colorfill-bg.png";
			...
			outlineImage.src = "images/nutzy-1.png";
		};
